  ...
  (function(global, factory) {
    ...
    function triggerEvent(element) {
      ...
      var event = new CustomEvent(type, {
        bubbles: bubbles,
        detail: _objectSpread2(_objectSpread2({}, detail), {}, { plyr: this })
      });
    ...
    var controls = {
      ...
      createIcon: function createIcon(type, attributes) {
        ...
        setAttributes(
          icon,
          extend(attributes, { "aria-hidden": "true", focusable: "false" })
        );
      ...
      updateProgress: function updateProgress(event) {
        ...
        var setProgress = function setProgress(target, input) {
          ...
          var progress = is$1.element(target)
            ? target
            : _this4.elements.display.buffer;
      ...
      create: function create(data) {
        ...
        var defaultAttributes = { class: "plyr__controls__item" };
        dedupe(
    ...
    var ui = {
      ...
      migrateStyles: function migrateStyles() {
        var _this5 = this;
        Object.values(_objectSpread2({}, this.media.style))
          .filter(function(key) {
    ...
    var vimeo = {
      ...
      ready: function ready() {
        ...
        if (premium) {
          Object.assign(frameParams, { controls: false, sidedock: false });
        }
    ...
    var youtube = {
      ...
      ready: function ready() {
        ...
        var poster = player.poster;
        var container = createElement("div", { id: id, "data-poster": poster });
    ...
    var source = {
      insertElements: function insertElements(type, attributes) {
        ...
        if (is$1.string(attributes)) {
          insertElement(type, this.media, { src: attributes });
